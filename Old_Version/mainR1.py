...
def main():
    ...
    # Add arguments for input PDF and output image directory
    parser.add_argument("--input", type=str, help="Path to input PDF file")
    parser.add_argument("--output", type=str, help="Path to output image directory")
    ...
    if not (args.input and args.output):
        ...
        return
    # Define the input PDF path and output image directory
    pdf_path = args.input
